<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreviewChart.aspx.cs" Inherits="Operation_PreviewChart" %>
 
        <asp:Chart ID="TATChart" runat="server" RenderType="BinaryStreaming" ImageType="Png" Height="152px" Width="160px" Palette="BrightPastel" BackColor="#F3DFC1" borderlinestyle="Solid" backgradienttype="TopBottom" BorderlineWidth="2" BorderlineColor="181, 64, 1">
            <Titles>
