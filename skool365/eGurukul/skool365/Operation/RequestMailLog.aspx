<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RequestMailLog.aspx.cs" Inherits="Operation_RequestMailLog"
...
<asp:Content ID="Content1" ContentPlaceHolderID="MiddleContent" runat="server">
    ...
    <div style="position: fixed; z-index: 999; height: 75%; width: 75%; top: 20px; left: 20px; background-color: #e6f3f7; padding: 5px; border-color: #024e66; border-width: 2px; border-radius: 5px; display: none;"
        ...
        <div style="width: 100%; cursor: move; background-color: #d1e7f9;" id='customlightboxHeader'>
            ...
            <asp:Button ID="btnReply" Text="Reply" runat="server" OnClick="btnReply_Click"></asp:Button>
        </div>
        <hr />
    ...
    <%--<uc1:UC_PageHeader ID="UC_PageHeader1" runat="server" PageTitle="Request Mail Log" />--%>
                        ...
                        <asp:GridView ID="grdStyled" Width="100%" runat="server" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="LOG ID">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl1" Text='<%# Bind("[Log Id]") %>' runat="server"> </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="TO">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl1" Text='<%# Bind("To") %>' runat="server"> </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="CC">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl1" Text='<%# Bind("CC") %>' runat="server"> </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="FROM">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl1" Text='<%# Bind("From") %>' runat="server"> </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="SUBJECT">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl1" Text='<%# Bind("Subject") %>' runat="server"> </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="MESSAGE">
                                    <ItemTemplate>
                                        ...
                                        <div style="display: none;" id="dvdtl<%# Container.DataItemIndex + 1 %>"><%# System.Web.HttpUtility.HtmlEncode(Eval("Message_DTL")) %>  </div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
