<%@ Page Title="" Language="C#" MasterPageFile="~/Operation/CRMOperationArea2.Master"
    AutoEventWireup="true" CodeFile="FeeHeader.aspx.cs" Inherits="Operation_FeeHeader" %>
                    ...
                    <div style="height: 95%;">
                        ...
                        <table width="60%" style="margin-left: 250px;" cellspacing="8px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlSegment" runat="server" Style="width: 200px; border: #aaaaaa 1px solid; background-color: #fbfbfb;">
                            ...
                            <tr >
                                <td>
                                    <strong>Header Code<span style="color: red;">*</span></strong>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtHeaderCode" runat="server" MaxLength="10" Width="350px" CssClass="hasDatepicker" autocomplete="off"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="regtxtHeaderCode" runat="server" ControlToValidate="txtHeaderCode"
                            ...
                            <tr>
                                <td>
                                    <strong>Header Name <span style="color: red;">*</span></strong>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtHeaderName" runat="server" MaxLength="50" Width="350px" CssClass="hasDatepicker" autocomplete="off"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="regtxtHeaderName" runat="server" ControlToValidate="txtHeaderName"
                                        ErrorMessage="*" SetFocusOnError="True" CssClass="RequiredFieldValidatorColor"
                                        ForeColor="Red"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr >
                                <td></td>
                                <td>
                                    <asp:CheckBox ID="chkGSTApplicable" ForeColor="Red" runat="server" Enabled="true" Checked="false" Text="Check if GST Applied on this header" />
                                </td>
                            </tr>
                            <tr id="rwStatus" runat="server" visible="false">
                                <td></td>
                                <td>
                                    <asp:CheckBox ID="chkActivated" runat="server" Enabled="false" Checked="true" Text="Check if change fee header's status status to Active" />
                                </td>
                            </tr>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <div style="width: 100%; overflow: auto; border: 2px solid #000; max-height: 380px;">
                            <asp:GridView ID="grdStyled" runat="server" AutoGenerateColumns="False" DataKeyNames="id"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="SEGMENT" HeaderText="Section *" />
                                    <asp:BoundField DataField="Header_CODE" HeaderText="Header Code*" />
                                    <asp:BoundField DataField="Header_name" HeaderText="Header Name*" />
                                    <asp:BoundField DataField="GST_Applicable" HeaderText="GST Applicable*" />
