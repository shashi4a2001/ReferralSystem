            ...
            <div class="rigteditpan">
                <div class="username">
                    <form id="form1" runat="server">
                         ...
                         <a style="text-align:right;" href="Operation/SignupSt.aspx">Signup form for Student(s)</a>
                        ...
                        <div>
                            ...
                            <asp:TextBox ID="txtEmail" runat="server" size="45" title="Email ID" MaxLength="100"
                                AutoCompleteType="Disabled" class="validate[required] text-input" placeholder="EMAIL ID"
                                tooltipText="Type Your Email ID" autocomplete="off"></asp:TextBox>
